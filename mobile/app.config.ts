...
export default ({ config }: ConfigContext): ExpoConfig => {
  return {
    ...
    scheme: 'boloui-mobile',
    userInterfaceStyle: 'automatic',
    ios: {
      supportsTablet: true,
      bundleIdentifier: 'ai.resopod.boloui',
      buildNumber: String(VERSION.buildNumber),
      infoPlist: {
        ITSAppUsesNonExemptEncryption: false,
        NSCameraUsageDescription: 'BoloUi needs camera access to scan QR codes for server login.',
      },
    },
    android: {
      adaptiveIcon: {
