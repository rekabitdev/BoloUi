...
<p align="center">
  <a href="../../readme.md">English</a> | <a href="./readme_ch.md">简体中文</a> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <a href="./readme_es.md">Español</a> | <strong>Português</strong> | <a href="./readme_tr.md">Türkçe</a> | <a href="./readme_ru.md">Русский</a> | <a href="./readme_uk.md">Українська</a> | <a href="https://www.boloui.com" target="_blank">Site oficial</a>
</p>

<p align="center">
  <strong>💬 Comunidade:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-23.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/BoloUi" target="_blank">Twitter</a>
</p>
...
<p align="center">
  <a href="https://x.com/BoloUi/status/2079493379914961069">
    <img src="../../resources/kimi/contributor-bonus-black-blue.jpg" alt="BoloUi × Kimi Bônus para Contribuidores" width="600">
  </a>
</p>

<p align="center">
  🎁 <strong>Parceria BoloUi × Kimi</strong>: planos premium <strong>Kimi "Allegretto" grátis (valor de US$ 39/mês · ¥199/mês)</strong> para nossos contribuidores!
</p>

<h3 align="center">
  <a href="https://x.com/BoloUi/status/2079493379914961069">Ver detalhes da campanha e como resgatar →</a>
</h3>

<p align="center">
  <sub><strong>Kimi K3</strong> chegou e funciona de imediato no BoloUi — <a href="https://www.kimi.com/code?aff=boloui" target="_blank">assine um plano Kimi For Coding</a> ou obtenha uma chave de API (<a href="https://platform.kimi.ai?track_id=track-32e04532b08d460fac729191744fa75c&aff=boloui" target="_blank">Global</a> / <a href="https://platform.kimi.com?track_id=track-98f92981df1c4c61b2c68930ba3ab658&aff=boloui" target="_blank">China</a>)</sub>
</p>
...
[🤔 Por que escolher BoloUi?](#-por-que-escolher-boloui-sobre-claude-cowork) ·
...
**BoloUi é mais que um cliente de chat.** É uma plataforma Cowork onde os AI Agents trabalham com você no seu computador — lendo arquivos, escrevendo código, navegando na web e automatizando tarefas. Você pode ver tudo que o Agent faz e sempre está no controle.

|                                              | Clientes de chat AI tradicionais | **BoloUi (Cowork)**                                                                                                                |
| :------------------------------------------- | :------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------- |
...
BoloUi vem com um motor de Agent AI completo. Diferente de ferramentas que exigem instalar CLI Agents separadamente, **BoloUi funciona no momento em que você o instala**.
...
Se você já usa Claude Code, Codex, Hermes Agent ou OpenClaw, BoloUi os detecta automaticamente e permite fazer Cowork com todos eles — junto com o Agent integrado.
...
- **Gestão unificada de MCP** — gerencie ferramentas MCP (Model Context Protocol) em um só lugar; o BoloUi injeta ou sincroniza transportes compatíveis conforme os recursos de cada Agent
...
- **Execução paralela multi-agent** — Leader divide e delega tarefas a Teammates em paralelo; Agents externos se conectam via ACP (Agent Client Protocol) e o BoloUi coordena a equipe
...
Outros apps de AI te dão uma caixa de chat com sua chave API. **BoloUi te dá um Cowork Agent completo.**
...
As mesmas capacidades do Agent — leitura/escrita de arquivos, busca na web, geração de imagens, uso de ferramentas — independentemente do modelo que o alimenta. BoloUi suporta **30+ plataformas AI** incluindo serviços em nuvem e implantações locais.
...
BoloUi também suporta o serviço de gateway [NewAPI](https://github.com/QuantumNous/new-api) — um hub unificado de modelos AI que agrega e distribui vários LLMs. Alterne flexivelmente entre diferentes modelos na mesma interface para atender a vários requisitos de tarefas.
...
- **Habilidades de três camadas** — Habilidades integradas (incluídas com o BoloUi), habilidades personalizadas (suas próprias) e habilidades de Extension (contribuídas por extensões de terceiros); habilite/desabilite por conversa com o indicador de habilidades
...
BoloUi inclui **21 assistentes profissionais** com capacidades predefinidas, extensíveis através de habilidades personalizadas:
...
- **🧭 BoloUi Butler** — Orientação do produto, ajuda de configuração e solução de problemas dentro do BoloUi
...
> 💡 As definições integradas oficiais estão no [catálogo de assistentes](https://github.com/iOfficeAI/AionCore/blob/main/crates/boloui-app/assets/builtin-assistants/assistants.json) do AionCore. As regras continuam em Markdown e podem ser personalizadas no BoloUi.
...
_Seu assistente AI 24/7 — acesse BoloUi de qualquer dispositivo, em qualquer lugar._
...
> **Configuração:** BoloUi Settings → WebUI Settings → Channel, configure o Bot Token.
...
> [Tutorial de acesso remoto à Internet](https://github.com/iOfficeAI/BoloUi/wiki/Remote-Internet-Access-Guide-Chinese)
...
- **Evitar suspensão** — O BoloUi previne automaticamente a suspensão do sistema enquanto as tarefas estão ativas e detecta acionamentos perdidos após o despertar
...
> [Guia de configuração do modelo de geração de imagens](https://github.com/iOfficeAI/BoloUi/wiki/BoloUi-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Por que escolher BoloUi sobre Claude Cowork?
...
BoloUi é um **Desktop Multi-AI Agent gratuito e de código aberto**. Comparado ao Claude Cowork que só roda no macOS e está bloqueado ao Claude, BoloUi é sua versão aprimorada de modelo completo e multiplataforma.

| Dimensão           | Claude Cowork  | BoloUi                                              |
| :----------------- | :------------- | :-------------------------------------------------- |
...
R: <strong>Não.</strong> BoloUi tem um AI Agent integrado que funciona imediatamente após a instalação. Basta inserir qualquer chave API para começar. Se você também tiver ferramentas CLI como Claude Code ou Gemini CLI instaladas, BoloUi as detectará e integrará automaticamente para ainda mais capacidades.
</details>

<details>
<summary><strong>P: O que posso fazer com BoloUi?</strong></summary>
R: BoloUi é seu <strong>espaço de trabalho Cowork privado</strong>. O Agent integrado pode organizar pastas em lote, processar dados do Excel, gerar documentos, buscar na web e gerar imagens. Com o Modo Multi-Agent, você também pode aproveitar Claude Code, Codex e outros Agents CLI poderosos através da mesma interface.
</details>

<details>
<summary><strong>P: É gratuito?</strong></summary>
R: BoloUi é completamente gratuito e de código aberto. Você paga apenas pelo uso da API do provedor que escolher, e pode usar chaves API de qualquer provedor que preferir.
</details>
...
## Veja como as pessoas usam BoloUi
...
> **Fez um vídeo sobre BoloUi?** [Avise-nos no X](https://x.com/BoloUi) e vamos destacá-lo aqui!
...
- [📖 Guia de instalação completo](https://github.com/iOfficeAI/BoloUi/wiki/Getting-Started) — Passos detalhados do download à configuração
- [⚙️ Guia de configuração LLM](https://github.com/iOfficeAI/BoloUi/wiki/LLM-Configuration) — Configuração de modelos AI multiplataforma
- [🤖 Configuração do modo Multi-Agent](https://github.com/iOfficeAI/BoloUi/wiki/ACP-Setup) — Integrar Agents AI de terminal
- [🔌 Configuração de ferramentas MCP](https://github.com/iOfficeAI/BoloUi/wiki/MCP-Configuration-Guide) — Configuração do servidor Model Context Protocol
- [🌐 Guia de configuração WebUI](https://github.com/iOfficeAI/BoloUi/wiki/WebUI-Configuration-Guide) — Tutorial completo de configuração e instalação do WebUI

**🎯 Casos de uso**

- [📁 Gerenciamento de arquivos](https://github.com/iOfficeAI/BoloUi/wiki/file-management) — Organização inteligente de arquivos
- [📊 Processamento de Excel](https://github.com/iOfficeAI/BoloUi/wiki/excel-processing) — Processamento de dados alimentado por AI
- [🎨 Geração de imagens](https://github.com/iOfficeAI/BoloUi/wiki/BoloUi-Image-Generation-Tool-Model-Configuration-Guide) — Criação de imagens AI
- [📚 Mais casos de uso](https://github.com/iOfficeAI/BoloUi/wiki/Use-Cases-Overview)

**❓ Suporte e ajuda**

- [❓ FAQ](https://github.com/iOfficeAI/BoloUi/wiki/FAQ) — Perguntas e solução de problemas
- [🔧 Tutoriais de configuração e uso](https://github.com/iOfficeAI/BoloUi/wiki/Configuration-Guides) — Documentação de configuração completa
...
- [GitHub Discussions](https://github.com/iOfficeAI/BoloUi/discussions) — compartilhe ideias e troque dicas
- [Reportar problemas](https://github.com/iOfficeAI/BoloUi/issues) — bugs e solicitações de recursos
- [Atualizações de lançamento](https://github.com/iOfficeAI/BoloUi/releases) — obtenha a última versão
...
O desenvolvimento local do BoloUi usa dois repositórios: BoloUi para o frontend Electron e AionCore para o backend local. Consulte o [guia de desenvolvimento](../contributing/development.md) para a configuração completa no macOS, Linux e Windows.
...
[Reportar bug](https://github.com/iOfficeAI/BoloUi/issues) · [Solicitar recurso](https://github.com/iOfficeAI/BoloUi/issues)
