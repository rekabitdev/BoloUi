...
BoloUi is a multi-process Electron app with three core layers: **renderer**, **main process**, and **preload/shared**.
...
├── base/           # UI primitives — BoloModal, BoloSelect, FlexFullContainer, etc.
