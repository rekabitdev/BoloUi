...
for f in BoloUi-1.0.0-win-x64.exe BoloUi-1.0.0-win-arm64.exe BoloUi-1.0.0-mac-x64.dmg BoloUi-1.0.0-mac-arm64.dmg BoloUi-1.0.0.deb BoloUi-1.0.0-arm64.deb; do
  if [ ! -f "$OUTPUT_DIR/$f" ]; then
