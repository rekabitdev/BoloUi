export const WORKSPACE_TOGGLE_EVENT = 'boloui-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'boloui-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'boloui-workspace-has-files';
