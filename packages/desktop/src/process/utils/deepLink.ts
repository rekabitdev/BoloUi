...
export const PROTOCOL_SCHEME = 'boloui';

/**
 * Parse an boloui:// URL into action and params.
 * Supports two formats:
 *   1. boloui://add-provider?base_url=xxx&api_key=xxx
 *   2. boloui://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
