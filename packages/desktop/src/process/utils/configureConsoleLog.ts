 ...
 *   - macOS:   ~/Library/Logs/BoloUi/YYYY/MM/DD/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\BoloUi\logs\YYYY\MM\DD\YYYY-MM-DD.log
 *   - Linux:   ~/.config/BoloUi/logs/YYYY/MM/DD/YYYY-MM-DD.log
 *
