...
export type BackendStartupFailureReason =
  ...
  // The local database was created by a newer BoloUi version (downgrade).
  // The data is intact; the fix is updating BoloUi, not reinstalling or
...
export interface BackendStartupFailureInfo {
  ...
  /** Currently installed BoloUi version, stamped by the main process when a
