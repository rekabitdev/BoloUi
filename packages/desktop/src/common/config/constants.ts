 ...
 */
export const BROWSER_SESSION_PARTITION = 'persist:boloui-browser';
 ...
 */
export const BUILTIN_BROWSER_MCP_NAME = 'boloui-browser';

// ===== 文件处理相关常量 =====

/** 临时文件时间戳分隔符 */
export const BOLOUI_TIMESTAMP_SEPARATOR = '_boloui_';

/** 用于匹配和清理时间戳后缀的正则表达式 */
export const BOLOUI_TIMESTAMP_REGEX = /_boloui_\d{13}(\.\w+)?$/;
export const BOLOUI_FILES_MARKER = '[[AION_FILES]]';

// ===== 跨会话消息相关常量 =====
// 必须与后端 crates/boloui-common/src/constants.rs 中的值逐字一致。

/** 发送侧：用户用 `@@` 引用其他会话后，后端追加到消息末尾的块 */
export const BOLOUI_SESSIONS_MARKER = '[[AION_SESSIONS]]';
export const BOLOUI_SESSIONS_END_MARKER = '[[/AION_SESSIONS]]';

/** 接收侧：跨会话投递时后端加在消息开头的来源块 */
export const BOLOUI_SESSION_MESSAGE_MARKER = '[[AION_SESSION_MESSAGE]]';
export const BOLOUI_SESSION_MESSAGE_END_MARKER = '[[/AION_SESSION_MESSAGE]]';
