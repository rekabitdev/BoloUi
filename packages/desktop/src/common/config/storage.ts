 ...
 * 会话来源类型 - 标识会话创建的来源
 */
export type ConversationSource = 'boloui' | 'telegram' | 'lark' | 'dingtalk' | 'weixin' | 'wecom' | (string & {});
...
interface IChatConversation<T, Extra> {
  ...
  /** 会话来源，默认为 boloui / Conversation source, defaults to boloui */
...
export type TChatConversation =
  ...
  // AionCore/crates/boloui-common/src/enums.rs and factory.rs.
...
export interface IMcpServer {
  ...
  /** Built-in MCP server managed by BoloUi (hide edit/delete in UI) */
  builtin?: boolean;
}
...
export const BUILTIN_IMAGE_GEN_NAME = 'boloui-image-generation';
export const BUILTIN_IMAGE_GEN_LEGACY_NAMES = ['BoloUi Image Generation', BUILTIN_IMAGE_GEN_ID] as const;
