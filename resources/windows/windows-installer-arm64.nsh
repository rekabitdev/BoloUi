...
!define BOLOUI_TARGET_ARCH "arm64"
!define BOLOUI_RUNTIME_KEY "win32-arm64"
!define BOLOUI_EXTRACT_METHOD "zip"
...
!macro customFiles_arm64
  !insertmacro BOLOUI_LOG_EXTRACT_RESULT "zip"
!macroend
...
!macro BOLOUI_ASSERT_TARGET_ARCH
  ...
  ${IfNot} ${IsNativeARM64}
    ...
    !insertmacro BOLOUI_FAIL_UX \
      ...
      "target=arm64 actual=$BoloUiActualArch" \
