...
<p align="center">
  <strong>English</strong> | <a href="./docs/readme/readme_ch.md">简体中文</a> | <a href="./docs/readme/readme_tw.md">繁體中文</a> | <a href="./docs/readme/readme_jp.md">日本語</a> | <a href="./docs/readme/readme_ko.md">한국어</a> | <a href="./docs/readme/readme_es.md">Español</a> | <a href="./docs/readme/readme_pt.md">Português</a> | <a href="./docs/readme/readme_tr.md">Türkçe</a> | <a href="./docs/readme/readme_ru.md">Русский</a> | <a href="./docs/readme/readme_uk.md">Українська</a> | <a href="https://www.boloui.com" target="_blank">Official Website</a>
</p>

<p align="center">
  <strong>💬 Community:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="./resources/wx-23.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/BoloUi" target="_blank">Twitter</a>
</p>

---

<p align="center">
  <a href="https://x.com/BoloUi/status/2079493379914961069" target="_blank">
    <img src="./resources/kimi/contributor-bonus-black-blue.jpg" alt="BoloUi × Kimi Contributor Bonus" width="600">
  </a>
</p>

<p align="center">
  🎁 <strong>BoloUi × Kimi Partnership</strong>: Free premium <strong>Kimi "Allegretto" plans ($39/mo · ¥199/mo value)</strong> for our contributors!
</p>

<h3 align="center">
  <a href="https://x.com/BoloUi/status/2079493379914961069" target="_blank">View Campaign Details & How to Claim →</a>
</h3>

<p align="center">
  <sub><strong>Kimi K3</strong> is here and works out of the box in BoloUi — <a href="https://www.kimi.com/code?aff=boloui" target="_blank">get a Kimi For Coding plan</a> or an API key (<a href="https://platform.kimi.ai?track_id=track-32e04532b08d460fac729191744fa75c&aff=boloui" target="_blank">Global</a> / <a href="https://platform.kimi.com?track_id=track-98f92981df1c4c61b2c68930ba3ab658&aff=boloui" target="_blank">China</a>) · ready to claim? <a href="https://github.com/iOfficeAI/BoloUi/discussions/3640">comment here</a></sub>
</p>
...
[Why Choose BoloUi?](#-why-choose-boloui-over-claude-cowork) ·
...
**BoloUi is more than a chat client.** It's a Cowork platform where AI agents work alongside you on your computer — reading files, writing code, browsing the web, and automating tasks. You see everything the agent does, and you're always in control.

|                                 | Traditional AI Chat Clients | **BoloUi (Cowork)**                                                                                                                      |
| :------------------------------ | :-------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------- |
...
BoloUi ships with a complete AI agent engine. Unlike tools that require you to install CLI agents separately, **BoloUi works the moment you install it**.
...
These tracks match what the app actually ships: **Morph PPT** presets and the **`pptx` / `docx` / `xlsx` skills**. The canonical [assistant catalog](https://github.com/iOfficeAI/AionCore/blob/main/crates/boloui-app/assets/builtin-assistants/assistants.json) and [built-in skills](https://github.com/iOfficeAI/AionCore/tree/main/crates/boloui-app/assets/builtin-skills) are maintained with AionCore. Want document/table output? BoloUi’s built-in **[OfficeCLI](https://github.com/iOfficeAI/OfficeCLI)** helps PPT (Morph), Word (`.docx`), and Excel (`.xlsx/.xlsm/.csv`) go from request to deliverable faster and more reliably.
...
If you already use Claude Code, Codex, Hermes Agent, or OpenClaw, BoloUi auto-detects them and lets you Cowork with all of them — alongside the built-in agent.
...
- **MCP Unified Management** — manage MCP (Model Context Protocol) tools in one place; BoloUi injects or syncs compatible transports according to each agent's capabilities
...
- **Parallel multi-agent execution** — Leader breaks tasks into subtasks and delegates to Teammate agents running in parallel; each Teammate uses its own model through the selected backend. External agents connect through ACP (Agent Client Protocol), while BoloUi coordinates the team
...
Other AI apps give you a chatbox with your API key. **BoloUi gives you a full Cowork agent.**
...
Same agent capabilities — file read/write, web search, image generation, tool use — regardless of which model powers it. BoloUi supports **30+ AI platforms** including cloud services and local deployments.
...
BoloUi also supports [NewAPI](https://github.com/QuantumNous/new-api) gateway service — a unified AI model hub that aggregates and distributes various LLMs. Flexibly switch between different models in the same interface to meet various task requirements.
...
- **Three-tier Skills** — Builtin skills (shipped with BoloUi), custom skills (your own), and Extension skills (contributed by third-party extensions); enable/disable per conversation with the skill indicator
...
BoloUi supports three skill layers: **built-in** skills (shipped with the app), **custom** skills (user-defined), and **extension** skills (loaded from the Extension SDK).
...
BoloUi includes **21 professional assistants** with predefined capabilities, extendable through custom skills:
...
- **🧭 BoloUi Butler** — Product guidance, setup help, and troubleshooting inside BoloUi

**Custom Skills**: Import or create skills from **Settings → Skills**, then attach them to assistants as needed. Skills come from three sources: built-in (shipped with BoloUi), custom (your own), and Extension (contributed via the Extension SDK). Built-in skills include `pptx`, `docx`, `pdf`, `xlsx`, `mermaid`, and more.

> 💡 The canonical built-in definitions live in AionCore's [assistant catalog](https://github.com/iOfficeAI/AionCore/blob/main/crates/boloui-app/assets/builtin-assistants/assistants.json); assistant rules remain Markdown and can be customized in BoloUi.
...
_Your 24/7 AI assistant — access BoloUi from any device, anywhere._
...
> **Setup:** BoloUi Settings → WebUI Settings → Channel, configure the Bot Token.
...
> [Remote Internet Access Tutorial](https://github.com/iOfficeAI/BoloUi/wiki/Remote-Internet-Access-Guide-Chinese)
...
- **Keep-awake** — BoloUi automatically prevents system sleep while tasks are active, and detects missed triggers after wake
...
> [Image generation model configuration guide](https://github.com/iOfficeAI/BoloUi/wiki/BoloUi-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Why Choose BoloUi Over Claude Cowork?
...
BoloUi is a **free and open-source Multi-AI Agent Desktop**. Compared to Claude Cowork which only runs on macOS and is locked to Claude, BoloUi is its full-model, cross-platform enhanced version.

| Dimension     | Claude Cowork | BoloUi                                                    |
| :------------ | :------------ | :-------------------------------------------------------- |
...
A: <strong>No.</strong> BoloUi has a built-in AI agent that works immediately after installation. Just enter any API key to get started. If you also have CLI tools like Claude Code or Gemini CLI installed, BoloUi will auto-detect and integrate them for even more capabilities.
</details>

<details>
<summary><strong>Q: What can I do with BoloUi?</strong></summary>
A: BoloUi is your <strong>private Cowork workspace</strong>. The built-in agent can batch organize folders, process Excel data, generate documents, search the web, and generate images. With Multi-Agent Mode, you can also leverage Claude Code, Codex, and other powerful CLI agents through the same interface.
</details>

<details>
<summary><strong>Q: Is it free?</strong></summary>
A: BoloUi is completely free and open source. You only pay for the API usage of whichever provider you choose, and you can use API keys from any provider you prefer.
</details>

<details>
<summary><strong>Q: Can I run BoloUi on a server (headless)?</strong></summary>
A: Yes — BoloUi WebUI mode runs as a standalone HTTP server. See the WebUI section above for setup instructions.
</details>
...
> **Made a video about BoloUi?** [Let us know on X](https://x.com/BoloUi) and we'll feature it here!
...
- [📖 Complete Installation Guide](https://github.com/iOfficeAI/BoloUi/wiki/Getting-Started) — Detailed steps from download to configuration
- [⚙️ LLM Configuration Guide](https://github.com/iOfficeAI/BoloUi/wiki/LLM-Configuration) — Multi-platform AI model configuration
- [🤖 Multi-Agent Mode Setup](https://github.com/iOfficeAI/BoloUi/wiki/ACP-Setup) — Integrate terminal AI agents
- [🔌 MCP Tool Configuration](https://github.com/iOfficeAI/BoloUi/wiki/MCP-Configuration-Guide) — Model Context Protocol server setup
- [🌐 WebUI Configuration Guide](https://github.com/iOfficeAI/BoloUi/wiki/WebUI-Configuration-Guide) — Complete WebUI setup and configuration tutorial

**🎯 Use Cases**

- [📁 File Management](https://github.com/iOfficeAI/BoloUi/wiki/file-management) — Smart file organization
- [📊 Excel Processing](https://github.com/iOfficeAI/BoloUi/wiki/excel-processing) — AI-driven data processing
- [🎨 Image Generation](https://github.com/iOfficeAI/BoloUi/wiki/BoloUi-Image-Generation-Tool-Model-Configuration-Guide) — AI image creation
- [📚 More Use Cases](https://github.com/iOfficeAI/BoloUi/wiki/Use-Cases-Overview)

**❓ Support & Help**

- [❓ FAQ](https://github.com/iOfficeAI/BoloUi/wiki/FAQ) — Questions and troubleshooting
- [🔧 Configuration & Usage Tutorials](https://github.com/iOfficeAI/BoloUi/wiki/Configuration-Guides) — Complete configuration documentation
...
- [GitHub Discussions](https://github.com/iOfficeAI/BoloUi/discussions) — share ideas and exchange tips
- [Report Issues](https://github.com/iOfficeAI/BoloUi/issues) — bugs and feature requests
- [Release Updates](https://github.com/iOfficeAI/BoloUi/releases) — get the latest version
...
BoloUi local development uses two repositories: BoloUi for the Electron frontend and AionCore for the local backend. See the [Development Guide](docs/contributing/development.md) for the full macOS, Linux, and Windows setup.
...
[Report Bug](https://github.com/iOfficeAI/BoloUi/issues) · [Request Feature](https://github.com/iOfficeAI/BoloUi/issues)
