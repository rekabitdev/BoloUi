...
const makeGitHubReleaseResponse = () => [
  {
    ...
    name: 'v1.9.22',
    body: 'release notes',
    html_url: 'https://github.com/iOfficeAI/BoloUi/releases/tag/v1.9.22',
    published_at: '2026-04-29T00:00:00Z',
    prerelease: false,
    draft: false,
    assets: [
      {
        name: 'BoloUi-1.9.22-mac-arm64.dmg',
      ...
      {
        name: 'BoloUi-1.9.22-win-x64.exe',
        browser_download_url: 'https://github.com/iOfficeAI/BoloUi/releases/download/v1.9.22/BoloUi-1.9.22-win-x64.exe',
        size: 456,
        content_type: 'application/vnd.microsoft.portable-executable',
      },
      {
        name: 'BoloUi-1.9.22-linux-amd64.deb',
        browser_download_url:
...
files:
  - url: BoloUi-1.9.22-mac-arm64.dmg
    size: 123
  - url: BoloUi-1.9.22-win-x64.exe
    size: 456
  - url: BoloUi-1.9.22-linux-amd64.deb
    size: 789
path: BoloUi-1.9.22-mac-arm64.dmg
...
describe('updateBridge allowlist includes CDN host', () => {
  it('accepts static.boloui.com URLs for download', async () => {
    vi.resetModules();
    vi.clearAllMocks();
    ...
    try {
      ...
      const result = await handler({
        ...
        url: 'https://static.boloui.com/releases/1.9.22/BoloUi-1.9.22-mac-arm64.dmg',
        file_name: 'BoloUi-1.9.22-mac-arm64.dmg',
      });
